    ...
    buildcontrol: {
      dist: {
        options: {
          ...
          remote: 'git@github.com:pocketbird/francy.git',
          branch: 'gh-pages'
        }
      }
    },
      ...
      dist: {
        options: {
          patterns: [
            {
              match: /("|'?)\/?styles\//g,
              replacement: '$1http://pocketbird.github.io/francy/styles/'
            },
            {
              match: /("|'?)\/?scripts\//g,
              replacement: '$1http://pocketbird.github.io/francy/scripts/'
            },
            {
              match: /(<a[^>]*href="?)(\/)/g,
              replacement: '$1http://pocketbird.github.io/francy/'
            },
            {
              match: /(<form[^>]*action="?)(\/)/g,
              replacement: '$1http://pocketbird.github.io/francy/'
